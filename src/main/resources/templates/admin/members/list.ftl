                ...
                <div class="panel-body">
                    <form class="form-inline">
                        ...
                        <div class="form-group" style="margin-right: 10px">
                            <label>状态</label>
                            <select class="form-control" id="editForm" name="state">
                                <option value="1">启用</option>
                                <option value="0">禁用</option>
                            </select>
                        </div>

                        <button type="button" class="btn btn-primary" id="btnSave" style="margin-right: 10px">状态修改</button>

                        <div class="form-group">
                            <label>名称</label>
                            <input type="text" class="form-control" id="membersown">
                        </div>
                        ...
                        <button type="button" class="btn btn-primary" id="btnSearch" style="margin-right: 10px">搜索</button>
...
<!-- 自定义 role.js -->
<script src="${ctx }/static/js/admin/members.js?v=1.0.0"></script>
