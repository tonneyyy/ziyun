                ...
                <div class="modal-body">
                   <form id="editForm"  class="form-horizontal" >
                       ...
                       <div class="form-group">
                           ...
                           <div class="col-sm-10">
                               <input type="text" class="form-control" id="edit_rolename" name="rolename"  data-bv-trigger="blur"   placeholder="角色名称">
                           </div>
                       </div>
                       ...
                       <div class="form-group">
                           ...
                           <div class="col-sm-10">
                               <input type="text" class="form-control" id="edit_authority" name="authority" data-bv-trigger="blur" placeholder="权限标识">
                           </div>
                       </div>
...
<!-- 自定义 role.js -->
<script src="${ctx }/static/js/admin/role.js?v=1.0.0"></script>
