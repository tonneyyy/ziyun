                ...
                <div class="modal-body">
                    <form id="editForm"  class="form-horizontal" >
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="edit_majorname" name="name"  data-bv-trigger="blur"   placeholder="角色编号">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <select class="form-control" id="edit_type" name="type">
                                    <option value="1">作品标签</option>
                                    <option value="2">作品内容</option>
                                    <option value="3">作品类型</option>
